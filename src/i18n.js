...
const DICT = {
  ...
  'Video exportado ({s} s, {w}x{h} {f})': 'Video exported ({s} s, {w}x{h} {f})',
  ...
  'Archivo': 'File', 'Edición': 'Edit', 'Vista': 'View',
  'Herramientas': 'Tools', 'Ventana': 'Window', 'Ayuda': 'Help',
  'Nueva escena…': 'New Scene…',
  'Abrir escena…': 'Open Scene…',
  'Importar escena (JSON)…': 'Import Scene (JSON)…',
  'Guardar como…': 'Save As…',
  'Exportar prompt…': 'Export Prompt…',
  'Exportar video…': 'Export Video…',
  'Exportar escena (JSON)': 'Export Scene (JSON)',
  'Proyectos…': 'Projects…',
  'Deshacer': 'Undo', 'Rehacer': 'Redo',
  'Agrupar objetos…': 'Group Objects…',
  'Desagrupar objetos…': 'Ungroup Objects…',
  'Cuadrícula': 'Grid',
  'Mostrar todos los props': 'Show All Props',
  'Ocultar todos los props': 'Hide All Props',
  'Ajustes de cámara…': 'Camera Settings…',
  'Guardar toma…': 'Save Shot…',
  'Editor de keyframes': 'Keyframe Editor',
  'Ajustes de prompt…': 'Prompt Settings…',
  'Visibilidad de props…': 'Prop Visibility…',
  'Notas de escena…': 'Scene Notes…',
  'Preferencias…': 'Preferences…',
  'Atajos de teclado…': 'Keyboard Shortcuts…',
  'Cursor infinito (vuelo libre)': 'Infinite Cursor (free flight)',
  'Modo de rotación…': 'Rotation Mode…',
  'Ajustes de niebla…': 'Fog Settings…',
  'Colecciones de escena…': 'Scene Collections…',

  // --- exportar prompt / video ---
  'Exportar prompt': 'Export prompt',
  'Descargar .txt': 'Download .txt',
  'Generado desde {v}. Las reglas de Director > Ajustes de prompt ya están aplicadas.': 'Generated from {v}. The rules in Director > Prompt Settings are already applied.',
  'Exportar video': 'Export video',
  'Duración': 'Duration',
  'Formato': 'Format',
  'no soportado por este navegador': 'not supported by this browser',
  'MP4 (H.264) mejora la compatibilidad con otras plataformas, pero depende del navegador (Chrome/Edge recientes). Si no está disponible, usa WebM.': 'MP4 (H.264) improves compatibility with other platforms, but depends on the browser (recent Chrome/Edge). If unavailable, use WebM.',

  // --- ajustes de cámara / notas de escena ---
  'Ajustes de cámara': 'Camera settings',
  'picado / contrapicado': 'high / low angle',
  'paneo': 'pan',
  'inclinación (Dutch angle)': 'tilt (Dutch angle)',
  'Pitch +90° mira al cénit y -90° al nadir; el roll inclina el horizonte.': 'Pitch +90° looks at the zenith and -90° at the nadir; roll tilts the horizon.',
  'Cámara "{n}" actualizada': 'Camera "{n}" updated',
  'Notas de escena': 'Scene notes',
  'La descripción se usa en los prompts generados.': 'The description is used in generated prompts.',
  'Notas de escena actualizadas': 'Scene notes updated',

  // --- reglas de prompt / visibilidad ---
  'Ajustes de prompt': 'Prompt settings',
  'Omitir objetos ocultos y de solo viewport': 'Omit hidden and viewport-only objects',
  'Omitir props con «copia» o «copy» en el nombre': 'Omit props with "copia" or "copy" in the name',
  'Omitir props duplicados (mismo tipo y nombre base)': 'Omit duplicate props (same type and base name)',
  'Omitir props marcados como auxiliares': 'Omit props marked as auxiliary',
  'Excepciones manuales: cada objeto puede forzar «Incluir siempre» u «Omitir siempre» desde el inspector o desde Visibilidad de props.': 'Manual exceptions: each object can force "Always include" or "Always omit" from the inspector or from Prop Visibility.',
  'Visibilidad de props': 'Prop visibility',
  'Sin personajes ni props en la escena.': 'No characters or props in the scene.',
  'Objeto': 'Object',
  'Visibilidad': 'Visibility',
  'Según reglas': 'By rules',
  'Según reglas de prompt': 'By prompt rules',
  'Incluir siempre': 'Always include',
  'Omitir siempre': 'Always omit',
  '«Solo viewport» se ve al editar pero queda fuera de capturas, preview final, video y prompt.': '"Viewport only" is visible while editing but excluded from captures, final preview, video and prompt.',
  'Visible en escena': 'Visible in scene',
  'Solo viewport (fuera de capturas y exportación)': 'Viewport only (excluded from captures & export)',
  'Oculto': 'Hidden',
  'Auxiliar': 'Auxiliary',
  'Bloqueado': 'Locked',
  'Marcado como auxiliar: las reglas de prompt pueden excluirlo': 'Marked as auxiliary: prompt rules can exclude it',
  'Bloqueado (no seleccionable con clic en el viewport)': 'Locked (not selectable by clicking in the viewport)',
  'Mostrar / ocultar': 'Show / hide',

  // --- preferencias / atajos ---
  'Preferencias': 'Preferences',
  'Idioma': 'Language',
  'Cursor infinito en vuelo libre (Pointer Lock)': 'Infinite cursor in free flight (Pointer Lock)',
  'Etiquetas 3D sobre personajes y cámaras': '3D labels over characters and cameras',
  'Cursor infinito: al volar con clic derecho, el ratón no se detiene en el borde de la pantalla. El gizmo de mover/rotar/escalar usa la posición real del cursor, por lo que ahí no aplica.': 'Infinite cursor: while flying with right click, the mouse does not stop at the screen edge. The move/rotate/scale gizmo uses the real cursor position, so it does not apply there.',
  'Atajos de teclado': 'Keyboard shortcuts',
  'Alternar Vista Libre / Vista de Cámara': 'Toggle Free View / Camera View',
  'Cambiar cámara activa': 'Cycle active camera',
  'Crear keyframe en el tiempo actual': 'Add keyframe at current time',
  'Reproducir / pausar trayectorias': 'Play / pause trajectories',
  'Ocultar / mostrar la selección': 'Hide / show selection',
  'Duplicar la selección': 'Duplicate selection',
  'Abrir / cerrar Trayectorias': 'Open / close Trajectories',
  'Exportar prompt de la vista': 'Export view prompt',
  'Clic en un atajo y pulsa la nueva tecla o combinación. Retroceso/Supr lo deja sin asignar; Esc cancela.': 'Click a shortcut and press the new key or combination. Backspace/Del unassigns it; Esc cancels.',
  'Atajos fijos': 'Fixed shortcuts',
  'Restablecer atajos por defecto': 'Reset default shortcuts',
  'Pulsa una tecla…': 'Press a key…',
  '— sin asignar —': '— unassigned —',

  // --- modo de rotación / niebla ---
  'Modo de rotación': 'Rotation mode',
  'Modo de rotación de la trayectoria': 'Trajectory rotation mode',
  'Rotación más corta (cuaternión)': 'Shortest rotation (quaternion)',
  'Rotación Euler (permite >360°)': 'Euler rotation (allows >360°)',
  'Cuaternión: interpola por el camino más corto (sin gimbal lock, máximo 180° entre keyframes). Euler: interpola los ángulos tal cual, lo que permite vueltas completas de más de 360° entre dos keyframes.': 'Quaternion: interpolates along the shortest path (no gimbal lock, max 180° between keyframes). Euler: interpolates the raw angles, allowing full turns of more than 360° between two keyframes.',
  'Trayectoria de': 'Trajectory of',
  'Abre Trayectorias y selecciona una entidad para cambiar su modo.': 'Open Trajectories and select an entity to change its mode.',
  'También disponible como selector en el panel de Trayectorias.': 'Also available as a selector in the Trajectories panel.',
  'Ajustes de niebla': 'Fog settings',
  'Niebla activa': 'Fog enabled',
  'Modo': 'Mode',
  'Lineal (distancia inicial → final)': 'Linear (start → end distance)',
  'Exponencial (densidad)': 'Exponential (density)',
  'Usar color del cielo': 'Use sky color',
  'Distancia inicial': 'Start distance',
  'Distancia final': 'End distance',
  'Densidad': 'Density',
  'La niebla por altura no está disponible: requiere modificar los materiales de toda la escena.': 'Height fog is not available: it would require custom materials for the whole scene.',
  ...
  'Bloquear / desbloquear todos': 'Lock / unlock all',
  'Desagrupar (la colección se elimina, los objetos no)': 'Ungroup (removes the collection, not the objects)',
  'Sin entidades en la escena.': 'No entities in the scene.',
  'Giro Y': 'Y turn',
  'Aplicar a todos': 'Apply to all',
  'Nueva colección': 'New collection',
  'con la selección': 'with the selection',
  'Sin colecciones. Crea una para agrupar personajes, props y cámaras por categorías (escenario, luces, auxiliares…).': 'No collections. Create one to group characters, props and cameras by category (set, lights, helpers…).',
  'Las colecciones agrupan objetos para mostrarlos, ocultarlos, bloquearlos o moverlos/rotarlos/escalarlos en bloque. Viajan con la escena.': 'Collections group objects to show, hide, lock or move/rotate/scale them together. They travel with the scene.',
  'Transformación aplicada a {n} objetos': 'Transform applied to {n} objects',
  'Colección bloqueada': 'Collection locked',
  'Colección desbloqueada': 'Collection unlocked'
};
