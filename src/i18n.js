...
const DICT = {
  ...
  'relación con cámara no determinada': 'relation to camera undetermined',
  'de frente a la cámara': 'facing the camera',
  'de espaldas a la cámara': 'back to the camera',
  'perfil izquierdo hacia la cámara': 'left profile to the camera',
  'perfil derecho hacia la cámara': 'right profile to the camera',
  ...
  'rotación XYZ': 'XYZ rotation',
  'pose neutra, articulaciones en 0°': 'neutral pose, joints at 0°',
  'No hay personajes visibles desde esta cámara.': 'No characters visible from this camera.',
  'Ej. mira hacia la puerta, camina hacia cámara, apunta al antagonista': 'E.g. looks at the door, walks toward camera, points at the antagonist',
  'Fotograma cinematográfico - {shot} desde la cámara "{cam}" (lente {mm} mm, FOV {fov}°, encuadre {ratio}, {angle}).': 'Cinematic frame - {shot} from camera "{cam}" ({mm} mm lens, FOV {fov}°, {ratio} frame, {angle}).',
  'ángulo picado (desde arriba)': 'high angle (from above)',
  'ángulo contrapicado (desde abajo)': 'low angle (from below)',
  'a la altura de los personajes': 'at character eye level',
  'tenue': 'dim', 'media': 'medium', 'intensa': 'intense',
  'Ambiente: cielo tipo {sky}, suelo de {floor}, iluminación {light}{fog}.': 'Environment: {sky} sky, {floor} floor, {light} lighting{fog}.',
  ', con niebla atmosférica': ', with atmospheric fog',
  'Personajes en cuadro:': 'Characters in frame:',
  'emoción': 'emotion',
  'dirección': 'direction',
  'Transform 3D: posición {p}, rotación XYZ {r}, escala {s}.': '3D transform: position {p}, XYZ rotation {r}, scale {s}.',
  'Pose corporal': 'Body pose',
  'preset "{n}"; ': 'preset "{n}"; ',
  'Sin personajes en cuadro.': 'No characters in frame.',
  'Props visibles': 'Visible props',
  'Mantener exactamente la composición, posiciones, escala y relación espacial entre personajes de la imagen de referencia adjunta.': 'Keep exactly the composition, positions, scale and spatial relations between characters from the attached reference image.'
};
