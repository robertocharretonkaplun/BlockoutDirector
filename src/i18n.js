...
const DICT = {
  ...
  'Video exportado ({s} s, 1600x900 WebM)': 'Video exported ({s} s, 1600x900 WebM)',
  ...
  '<b>Capturar</b> genera un JPG limpio 1600x900; <b>Guardar toma</b> ademas guarda encuadre, notas y un prompt listo para IA; el boton de video exporta la trayectoria como WebM.': '<b>Capture</b> renders a clean 1600x900 JPG; <b>Save shot</b> also stores framing, notes and an AI-ready prompt; the video button exports the trajectory as WebM.',
  ...
  'Controles': 'Controls',
  'Clic izquierdo + arrastrar: orbitar. Rueda: zoom. Clic derecho: paneo.': 'Left click + drag: orbit. Wheel: zoom. Right click: pan.',
  ...
  'Fotograma cinematografico - {shot} desde la camara "{cam}" (FOV {fov}°, {angle}).': 'Cinematic frame - {shot} from camera "{cam}" (FOV {fov}°, {angle}).',
